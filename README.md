...
- **[beta]** [acca-tracker](https://github.com/svenmedina07-ship-it/skills/tree/main/acca-tracker) by [Banozz](https://github.com/svenmedina07-ship-it) - Track football accumulator betting slips via live score monitoring. Parses slip photos (vision), supports 18+ bet types, delivers 15-minute cron reports with per-leg status and acca health. Works with any messaging platform (Telegram, Discord, etc.).
