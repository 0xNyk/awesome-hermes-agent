...
- **[beta]** [solana-rug](https://github.com/rugpullnet/solana-rug) by [rugpullnet](https://github.com/rugpullnet) - Open-source on-chain rug-pull detection for Solana tokens and wallets. 13-factor safety analysis using public Solana RPCs and DexScreener API. Works as a Hermes skill (`hermes skills install official/blockchain/solana-rug`) or standalone CLI. No API keys or registration needed. Covers mint/freeze authority, liquidity depth, holder concentration, sniper detection, wash trading, and Token-2022 extensions.
