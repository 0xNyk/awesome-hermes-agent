...
- **[production]** [hypernatt-terminal](https://smithery.ai/servers/hypernatt/hypernatt-terminal) by [DIALLOUBE-RESEARCH](https://github.com/DIALLOUBE-RESEARCH) — BTC Decision Terminal for AI Agents — **14 tools**, **10 free credits/day**, HOLD free, Agent Pass **$19/mo**. Live vault-backed BTC/USDC signals, MM trap/hunt, liq radar, Li.Fi swap. MCP `https://hypernatt.com/mcp/protocol` · Quickstart: https://github.com/DIALLOUBE-RESEARCH/hypernatt-terminal/blob/main/docs/quickstart.md · Stats: https://hypernatt.com/stats
