...
- **[production]** [hermes-skills (winterliu6)](https://github.com/winterliu6/hermes-skills) by [winterliu6](https://github.com/winterliu6) - Chinese-focused Hermes skills pack with three production-ready skills targeting domestic platforms: **content-studio** (小红书/抖音/公众号 content generator with full packages — title + body + storyboard + visual plan), **security-newsletter** (automated weekly cybersecurity awareness email pipeline), and **tech-ops-bot** (IT ops bot with 企业微信/飞书 integration, fault classification, knowledge base Q&A, daily reports, and web dashboard). Used in production at Yaolai Cinema IT department.
