...
- **[beta]** [sequenzy-email-marketing](https://github.com/Sequenzy/skills/tree/main/skills/sequenzy-email-marketing) by [Sequenzy](https://github.com/Sequenzy) - Agent skill for operating Sequenzy email marketing and transactional/product email workflows, including auth, subscribers, campaigns, sequences, and templates.
