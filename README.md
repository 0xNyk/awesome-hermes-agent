...
- **[beta]** [analyze-longevity](https://github.com/liveforeverbetter/agentic-longevity-analysis) by [wellnizz](https://github.com/liveforeverbetter) - Agent-first healthspan analysis: Whole Genome Sequencing interpretation (ClinVar, CPIC, PRS), 168+ biomarker analysis, wearable data processing (WHOOP, Oura, Garmin). MIT licensed. Install: `hermes skill install https://github.com/liveforeverbetter/agentic-longevity-analysis/blob/main/SKILL.md`.
- **[beta]** [wellnizz](https://app.wellnizz.com) by [wellnizz](https://github.com/liveforeverbetter) - Agent-first API for genetics, biomarkers, and wearables. 21 MCP tools for biomarkers, wearables, and genomic analysis. Self-hostable or hosted. Install: `hermes skill install https://app.wellnizz.com/SKILL.md`.
