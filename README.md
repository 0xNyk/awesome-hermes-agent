...
- **[production]** [hypernatt-terminal](https://smithery.ai/servers/hypernatt/hypernatt-terminal) by [DIALLOUBE-RESEARCH](https://github.com/DIALLOUBE-RESEARCH) - 6 MCP tools (v2.8.0): liquidation radar, Hyperliquid execution quotes, context comparison, fill reconciliation and Li.Fi cross-chain swap. BTC ETH SOL BNB XRP HYPE ZEC. Free manifest; one daily trial per paid tool/token (up to 28), then $0.001 USDC/call via x402 (Base + Solana). MCP: https://hypernatt.com/mcp/protocol. [Quickstart](https://github.com/DIALLOUBE-RESEARCH/hypernatt-terminal/blob/main/docs/quickstart.md).
