...
- **[production]** [OpenDexter](https://github.com/Dexter-DAO/opendexter-ide) by [Dexter-DAO](https://github.com/Dexter-DAO) - Give your Hermes agent a bank. The agent runtime for the Dexter stack: a passkey-secured non-custodial wallet (your tap is the only key in existence), plain-English search over a live-tested catalog of 21,000+ paid endpoints where every listing is re-verified by actually paying it, price-checks before any spend, and USDC settlement across 11 chains, Robinhood Chain included. `hermes mcp add opendexter --url https://open.dexter.cash/mcp` (needs `hermes-agent[mcp]`). [Docs](https://docs.dexter.cash/docs/operator/connect-your-wallet).
