...
- **[beta]** [runapi-cli-skill](https://github.com/runapi-ai/cli-skill) by [RunAPI](https://github.com/runapi-ai) - Portable skill for running RunAPI CLI workflows from Hermes-compatible agents. Supports AI image, video, music/audio, and model API jobs through public RunAPI assets.
