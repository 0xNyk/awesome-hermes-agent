...
- **[production]** [hermes-video-skills](https://github.com/pierrelucd670/hermes-video-skills) by [Peyo](https://github.com/pierrelucd670) - Three A40-tested video generation skills: **ltx23-generate** (LTX-2.3 + synced audio + 5 API bug fixes), **wan22-generate** (Wan 2.2 Turbo 4-step), and **pinkcherry-nsfw** (PinkCherry v1.6 + Heretic uncensored). Battle-tested on real hardware with all workflow API bugs documented. Install: `hermes skills tap add pierrelucd670/hermes-video-skills`.
