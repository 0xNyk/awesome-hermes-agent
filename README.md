...
- **[beta]** [plur-hermes](https://github.com/plur-ai/plur) by [plur-ai](https://github.com/plur-ai) - Persistent learning for Hermes agents. Open engram format (YAML), shared across tools, with meta-engrams for knowledge transfer.
