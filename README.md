...
- **[beta]** [hermes-skills (jiawood2006)](https://github.com/jiawood2006/hermes-skills) by [jiawood2006](https://github.com/jiawood2006) - Practical skills pack: **video-to-text** (Douyin/local video to text with metadata + transcription), **de-ai-writer** (removes AI-writing tells from Chinese copy), **doc-ocr** (PDF/scan to text via macOS Vision). Free to use, standard SKILL.md format, agentskills.io compatible.
