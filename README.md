...
- **[beta]** [hermes-agentcore-memory](https://github.com/sfalsin/hermes-agentcore-memory) by [sfalsin](https://github.com/sfalsin) - AWS Bedrock AgentCore Memory provider with namespace hierarchy (shared, sector, agent). Managed semantic search, instant indexing, multi-namespace prefetch, auto sync_turn. No infra to maintain — uses AWS managed service. MIT.
