...
- **[production]** [xiaoma-hermes-zh-cn](https://github.com/fresh-claw/hermes-zh-cn) by [fresh-claw](https://github.com/fresh-claw) - Chinese localization and onboarding package for Hermes Agent. One-command installer applies zh-CN UI text patches, gateway/platform prompts, pairing approval messages, and release metadata for Hermes 0.14.x, 0.13.x, and legacy versions. Public installer and guide at [useai.live/hermes](https://useai.live/hermes/).
