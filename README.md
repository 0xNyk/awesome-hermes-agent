...
- **[beta]** [feishu-document-api](https://github.com/duruonanni/hermes-skill-kit/tree/main/feishu-document-api) by [duruonanni](https://github.com/duruonanni) - Create, write, and manage Feishu/Lark documents programmatically via the Open API. Covers OAuth, block types, tables, ownership transfer with verify-then-reveal safety, and in-place sync. Codex-audited (GPT 5.5, score 8/10). Includes working scripts and reference docs.
- **[beta]** [hermes-memory-maintenance](https://github.com/duruonanni/hermes-skill-kit/tree/main/hermes-memory-maintenance) by [duruonanni](https://github.com/duruonanni) - Maintain Hermes agent memory (MEMORY.md/USER.md): audit redundancy, GATE-style hallucination prevention rules, quality scoring (0-4), drift detection & recovery, capacity planning, and write discipline. Includes memory_review.py automated audit script. Codex-audited (GPT 5.5, score 9/10).
