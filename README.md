...
- **[production]** [twitr-skills](https://github.com/lnvestor/twitr-skills) by [lnvestor](https://github.com/lnvestor) - Five X/Twitter skills: live reads and search, bulk dataset exports, real-time account/keyword monitors with HMAC-signed webhooks, publishing via a connected account, and an unattended presence routine for cron. Pay-per-call in USDC (x402 on Base/Solana, MPP on Tempo) — no API key, no signup.
