...
|- **[beta]** [hermes-skill-kit](https://github.com/duruonanni/hermes-skill-kit) by [duruonanni](https://github.com/duruonanni) - Three community-vetted skills: **feishu-document-api** (programmatic Feishu/Lark document creation), **feishu-response-format** (Feishu response formatting with 3 table schemes, Card JSON 2.0, Markdown compatibility, 53 tests, Claude Code-audited), **hermes-memory-maintenance** (MEMORY.md/USER.md audit and drift recovery). All Codex-audited.
