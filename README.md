...
- [marketing-mindset](https://github.com/axelfreeman/marketing-mindset) by [axelfreeman](https://github.com/axelfreeman) - Marketing and client-acquisition mindset skill used in Hermes: 3-month horizon, fast testable hypotheses, competitor-first research, and explicit minimum test volumes per channel (cold email, landing pages, paid ads) before a result can be called. Ships `llms.txt` for agent citation.
