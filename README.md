...
- **[beta]** [file-access-manager](https://github.com/marospekarik/paperclip-hermes-file-access-manager) — Kernel-enforced filesystem sandboxing for Hermes Agent profiles via Docker bind mounts. Paperclip plugin by Ordillect.
...
- **[beta]** [file-access-manager](https://github.com/marospekarik/paperclip-hermes-file-access-manager) — Enforces filesystem permissions at the kernel level so the agent's shell cannot bypass them. Denied paths are not mounted into the container at all.
