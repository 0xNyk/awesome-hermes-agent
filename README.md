...
- **[beta]** [hermes-agent-operator](https://github.com/hermeum/hermes-agent-operator) by [hermeum](https://github.com/hermeum) - Kubernetes operator that runs Hermes agents as declarative custom resources — one `HermesAgent` manifest holds config, skills, crons, profiles, and env, and the operator keeps the running agent in sync. MIT.
- **[beta]** [Hermeum](https://github.com/hermeum/hermeum) by [hermeum](https://github.com/hermeum) - Platform for tailored Hermes agents for your team: describe what an agent should do in chat, and Hermeum generates the spec and runs it on Kubernetes, with a dashboard to manage it. AGPL-3.0.
