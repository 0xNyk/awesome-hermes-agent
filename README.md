...
- **[production]** [hypernatt-terminal](https://smithery.ai/servers/hypernatt/hypernatt-terminal) by [DIALLOUBE-RESEARCH](https://github.com/DIALLOUBE-RESEARCH) — **[HyperNatt](https://hypernatt.com)** agent MCP (3 tools · v2.7.0): multi-crypto liq radar (BTC ETH SOL BNB XRP HYPE ZEC) + Li.Fi cross-chain swap. Free manifest · $0.001 USDC/call via x402 (Base + Solana). MCP https://hypernatt.com/mcp/protocol · [quickstart](https://github.com/DIALLOUBE-RESEARCH/hypernatt-terminal/blob/main/docs/quickstart.md)
