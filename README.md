...
- **[beta]** [hurmoz](https://github.com/Moshe-ship/hurmoz) by [Moshe-ship](https://github.com/Moshe-ship) - Arabic-first skills pack for Hermes — 63 skills across Islamic tools (prayer times, zakat, Quran), dialect-aware NLP, content, and travel. Install as a tap: `hermes skills tap add Moshe-ship/hurmoz`.
...
- **[beta]** [khwarizmi-hermes-plugin](https://github.com/Moshe-ship/khwarizmi-hermes-plugin) by [Moshe-ship](https://github.com/Moshe-ship) - Pre-LLM reliability preflight via `pre_llm_call`/`pre_tool_call`: restores implicit references (jabr), fails loud on contradictions (muqabalah), and gates tool calls against a constraint-driven allowlist (qadiya). Part of the [Mizan](https://github.com/Moshe-ship/mizan) reliability stack.
...
- **[beta]** [arabic-agent-eval](https://github.com/Moshe-ship/arabic-agent-eval) by [Moshe-ship](https://github.com/Moshe-ship) - Open, installable, dialect-split Arabic function-calling benchmark (51 items, 5 dialects) with a public [leaderboard](https://huggingface.co/spaces/Mosescreates/arabic-agent-eval-leaderboard). Measures whether agents keep Arabic in tool arguments instead of transliterating.
...
- **[beta]** [wasl](https://github.com/Moshe-ship/wasl) by [Moshe-ship](https://github.com/Moshe-ship) - Arabic MCP server — 30 tools (prayer times, Quran, Hijri dates, Arabic NLP) over the Model Context Protocol. `pip install wasl-mcp`.
