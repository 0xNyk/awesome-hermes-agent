...
- **[beta]** [hermes-snow-search](https://github.com/mlinquan/hermes-snow-search) by [mlinquan](https://github.com/mlinquan) - Global memory retrieval layer for Hermes Agent. Cross-session FTS5 search (~0.1s) across entire message history + memory + facts. CJK/English auto-routing. The agent remembers what happened on other devices. Also on [PyPI](https://pypi.org/project/hermes-snow-search/).
