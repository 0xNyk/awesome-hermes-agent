...
- **[experimental]** [tech-debt-management-skill](https://github.com/Vincent-crypto-coder/tech-debt-management-skill) by [Vincent-crypto-coder](https://github.com/Vincent-crypto-coder) - Systematic technical debt management for Python projects. Automates scanning (pylint, radon, safety, bandit, flake8), prioritizes debt with a 4-dimension matrix (frequency × scope × risk ÷ cost), and generates executable refactoring plans with verification scripts. Tested on a real 5000-line RAG project — reduced 4 E-grade complexity functions to C-grade and eliminated 3 duplicate code blocks.
