...
- **[production]** [KubeStellar Console kc-agent](https://github.com/kubestellar/console) by [KubeStellar](https://github.com/kubestellar) - MCP server bridging Hermes to multi-cluster Kubernetes environments. Provides cluster health, pod status, deployments, Argo CD sync state, Kyverno policies, and 20+ CNCF project integrations via MCP. Connects to any kubeconfig context and streams real-time observability data. CNCF Sandbox project.
