...
- **[production]** [camofox-browser](https://github.com/jo-inc/camofox-browser) by [jo-inc](https://github.com/jo-inc) - Stealth headless browser server for AI agents. Bypass Cloudflare, bot detection, and anti-scraping. Drop-in Puppeteer/Playwright replacement with REST API. The browser backend used by Hermes Agent. 3k+ stars, MIT licensed.
