...
- **[production]** [hypernatt-terminal](https://smithery.ai/servers/hypernatt/hypernatt-terminal) by [DIALLOUBE-RESEARCH](https://github.com/DIALLOUBE-RESEARCH) — **[HyperNatt](https://hypernatt.com)** agent MCP (9 tools): vault-backed BTC/USDC Decision Core, MM trap/hunt/liq radar, Li.Fi cross-chain swap. Flat $0.001 USDC/call via x402 (Base + Solana), HOLD free, $5/mo Agent Pass (~15k credits). MCP `https://hypernatt.com/mcp/protocol` · [stats](https://hypernatt.com/stats) · [quickstart](https://github.com/DIALLOUBE-RESEARCH/hypernatt-terminal/blob/main/docs/quickstart.md)
