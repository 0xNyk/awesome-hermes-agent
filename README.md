...
- **[production]** [longbridge](https://github.com/longbridge/skills/tree/main/skills/longbridge) by [Longbridge Securities](https://github.com/longbridge) - Live financial market skill for US, HK, A-share (SH/SZ), and Singapore markets. Real-time quotes, K-lines, capital flow, company fundamentals (IS/BS/CF), consensus EPS, options chain, portfolio positions, institutional data (13F, Form 4, short interest), and news/SEC filings. Requires Longbridge account + `longbridge auth login`. Ships with 125+ companion skills including Elliott Wave, Graham screening, DCF, and technical indicators. CLI v0.20.1 stable.
