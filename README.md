...
- **[beta]** [zooidfund](https://github.com/Ales375/zooidfund-skill) by [Ales375](https://github.com/Ales375) - agentskills.io-compatible skill that lets an agent discover, evaluate, and donate USDC on Base to humanitarian crowdfunding campaigns at [zooid.fund](https://zooid.fund). Public campaign browsing, peer-signal review, optional evidence access, and direct wallet-to-creator USDC transfers. Supports operator-reviewed or autonomous donation flows. Published on ClawHub.
