...
- **[production]** [hypernatt-signal](https://smithery.ai/servers/hypernatt/hypernatt-signal) by [DIALLOUBE-RESEARCH](https://github.com/DIALLOUBE-RESEARCH) — Pay-per-call MCP exposing **live signals from [HyperNatt](https://hypernatt.com)** (Mimo AI vault in prod on Hyperliquid: [public vault](https://app.hyperliquid.xyz/vaults/0x04e2eb302fe9ff23a9d1f2455084af624737a6d8)). Read-only BTC perp context—vault cycle, MM hunt score, similarity top-3. x402 $0.01 USDC/call on Base. Smithery `hypernatt/hypernatt-signal`; MCP `https://hypernatt.com/mcp/protocol`. Tools: `get_btc_usdc_signal`, `get_mm_hunt_score`, `get_similarity_match`. Stats: https://hypernatt.com/stats
